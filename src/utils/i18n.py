...
class I18n:
    ...
    def _load_translations(self):
        ...
        self.translations["zh"] = {
            ...
            "task.step.fetch": "正在获取应用 {app_id} 信息...",
            "task.step.download_start": "准备开始下载清单...",
            "task.step.configuring": "正在配置解锁工具...",
            "task.step.finish": "操作成功！请重启 Steam 以生效。",
            ...
            "error.invalid_tool": "选择了无效的解锁工具类型",
            "error.config_failed": "工具配置失败，请检查日志",
        }
        ...
        self.translations["en"] = {
            ...
            "task.step.fetch": "Fetching info for App {app_id}...",
            "task.step.download_start": "Preparing to download manifests...",
            "task.step.configuring": "Configuring unlock tools...",
            "task.step.finish": "Success! Please restart Steam to take effect.",
            ...
            "error.invalid_tool": "Invalid unlock tool type selected",
            "error.config_failed": "Tool configuration failed, please check logs",
        }
